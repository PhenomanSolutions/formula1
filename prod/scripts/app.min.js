...
function checkPageReady(a,n,c){c()?n.isLoading=!1:a(function(){checkPageReady(a,n,c)},500)}APP.run(["$rootScope","$timeout","$mdMedia",function(a,n,c){a.appTitle="Dashboard",a.isLoading=!0,a.compactNav=!1,a.driversData=[],a.$watch(function(){return c("xs")||c("sm")},function(n){a.compactNav=n}),n(function(){checkPageReady(n,a,function(){return!!jQuery&!!window.loaded})},1e3)}]);
