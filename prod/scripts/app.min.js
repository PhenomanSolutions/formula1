!function(){"use strict";function r(r,n){return n=n||Error,function(){var e,o=arguments[0];for(e="["+(r?r+":":"")+o+"] http://errors.angularjs.org/1.6.4/"+(r?r+"/":"")+o,o=1;o<arguments.length;o++){e=e+(1==o?"?":"&")+"p"+(o-1)+"=";var t;e+=encodeURIComponent(t="function"==typeof(t=arguments[o])?t.toString().replace(/ \{[\s\S]*$/,""):void 0===t?"undefined":"string"!=typeof t?JSON.stringify(t):t)}return new n(e)}}!function(n){function e(r,n,e){return r[n]||(r[n]=e())}var o=r("$injector"),t=r("ng");n=e(n,"angular",Object),n.$$minErr=n.$$minErr||r,e(n,"module",function(){var r={};return function(n,i,u){var c={};if("hasOwnProperty"===n)throw t("badname","module");return i&&r.hasOwnProperty(n)&&(r[n]=null),e(r,n,function(){function r(r,n,e,o){return o||(o=f),function(){return o[e||"push"]([r,n,arguments]),p}}function e(r,e,o){return o||(o=f),function(t,i){return i&&"function"==typeof i&&(i.$$moduleName=n),o.push([r,e,arguments]),p}}if(!i)throw o("nomod",n);var f=[],a=[],v=[],d=r("$injector","invoke","push",a),p={_invokeQueue:f,_configBlocks:a,_runBlocks:v,info:function(r){if(void 0!==r){if(null===r||"object"!=typeof r)throw t("aobj","value");return c=r,this}return c},requires:i,name:n,provider:e("$provide","provider"),factory:e("$provide","factory"),service:e("$provide","service"),value:r("$provide","value"),constant:r("$provide","constant","unshift"),decorator:e("$provide","decorator",a),animation:e("$animateProvider","register"),filter:e("$filterProvider","register"),controller:e("$controllerProvider","register"),directive:e("$compileProvider","directive"),component:e("$compileProvider","component"),config:d,run:function(r){return v.push(r),this}};return u&&d(u),p})}})}(window)}(window);
...
!function(n,e,s){function o(n,e){return typeof n===e}var a=[],t=[],i={_version:"3.5.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(n,e){var s=this;setTimeout(function(){e(s[n])},0)},addTest:function(n,e,s){t.push({name:n,fn:e,options:s})},addAsyncTest:function(n){t.push({name:null,fn:n})}},l=function(){};l.prototype=i,l=new l;var f=e.documentElement,r="svg"===f.nodeName.toLowerCase();(function(){var n,e,s,i,f,r,c;for(var u in t)if(t.hasOwnProperty(u)){if(n=[],(e=t[u]).name&&(n.push(e.name.toLowerCase()),e.options&&e.options.aliases&&e.options.aliases.length))for(s=0;s<e.options.aliases.length;s++)n.push(e.options.aliases[s].toLowerCase());for(i=o(e.fn,"function")?e.fn():e.fn,f=0;f<n.length;f++)r=n[f],c=r.split("."),1===c.length?l[c[0]]=i:(!l[c[0]]||l[c[0]]instanceof Boolean||(l[c[0]]=new Boolean(l[c[0]])),l[c[0]][c[1]]=i),a.push((i?"":"no-")+c.join("-"))}})(),function(n){var e=f.className,s=l._config.classPrefix||"";if(r&&(e=e.baseVal),l._config.enableJSClass){var o=new RegExp("(^|\\s)"+s+"no-js(\\s|$)");e=e.replace(o,"$1"+s+"js$2")}l._config.enableClasses&&(e+=" "+s+n.join(" "+s),r?f.className.baseVal=e:f.className=e)}(a),delete i.addTest,delete i.addAsyncTest;for(var c=0;c<l._q.length;c++)l._q[c]();n.Modernizr=l}(window,document);
var DONT_CHACHE=+new Date,APP=angular.module("APP",["angular-page-loader","angular-loading-bar","ngMaterial","ngRoute","ui.router","ngAnimate","cfp.loadingBar","ngSanitize"]).constant("API_INFO",{url:"http://ergast.com/api/f1/",winnersUrl:"http://ergast.com/api/f1/driverStandings/1.json?offset={0}&limit={1}",roundWinners:"http://ergast.com/api/f1/{0}/results/1.json"}).config(["$sceDelegateProvider","API_INFO",function(e,r){e.resourceUrlWhitelist(["self","/",r.url+"**.json**"])}]).config(["cfpLoadingBarProvider","$mdThemingProvider",function(e,r){e.includeSpinner=!1,e.includeBar=!0,r.theme("default").primaryPalette("blue-grey").accentPalette("red")}]);
function checkPageReady(a,n,o){o()?n.isLoading=!1:a(function(){checkPageReady(a,n,o)},500)}APP.run(["$rootScope","$timeout","$mdMedia",function(a,n,o){a.appTitle="Dashboard",a.isLoading=!0,a.compactNav=!1,a.driversData=[],a.$watch(function(){return o("xs")||o("sm")},function(n){a.compactNav=n}),window.loaded=!0,a.isLoading=!1,n(function(){checkPageReady(n,a,function(){return!!jQuery&!!window.loaded})},1e3)}]);
APP.config(["$urlRouterProvider","$locationProvider","$stateProvider",function(e,t,l){t.html5Mode(!1).hashPrefix(""),e.otherwise("/home"),l.state("home",{url:"/home",views:{main:{templateUrl:"/templates/_layout.html?_="+DONT_CHACHE,controller:"homeController"},"header@home":{templateUrl:"/templates/home/header.html?_="+DONT_CHACHE},"content@home":{templateUrl:"/templates/home/winnersList.html?_="+DONT_CHACHE},"leftbar@home":{templateUrl:"/templates/shared/leftMenu.html?_="+DONT_CHACHE}}}).state("details",{url:"/details?:driverId&:seasonId",views:{main:{templateUrl:"/templates/_layout.html?_="+DONT_CHACHE,controller:"detailsController"},"header@details":{templateUrl:"/templates/shared/header.html?_="+DONT_CHACHE},"content@details":{templateUrl:"/templates/details/detailsPage.html?_="+DONT_CHACHE},"leftbar@details":{templateUrl:"/templates/shared/leftMenu.html?_="+DONT_CHACHE}}}).state("about",{url:"/about",views:{main:{templateUrl:"/templates/_layout.html?_="+DONT_CHACHE,controller:"aboutController"},"header@about":{templateUrl:"/templates/shared/header.html?_="+DONT_CHACHE},"content@about":{templateUrl:"/templates/about/aboutPage.html?_="+DONT_CHACHE},"leftbar@about":{templateUrl:"/templates/shared/leftMenu.html?_="+DONT_CHACHE}}})}]);
String.prototype.format||(String.prototype.format=function(){var t=arguments;return this.replace(/{(\d+)}/g,function(r,o){return void 0!==t[o]?t[o]:""})});
APP.service("driversService",["$http","$q","API_INFO",function(r,a,e){var n={FROM_YEAR_IS_REQUIRED:"'fromYear' is Required.",TO_YEAR_IS_REQUIRED:"'fromYear' is Required.",YEAR_IS_REQUIRED:"'year' is Required."};return{getWinnersList:function(t,i){var s=a.defer();if(!t||!i)throw new Error(t?n.TO_YEAR_IS_REQUIRED:n.FROM_YEAR_IS_REQUIRED);var o=e.winnersUrl.format(t-1950,i-t+1);return r.jsonp(o,{jsonpCallbackParam:"callback"}).then(function(r){var a=[];try{a=r.data.MRData.StandingsTable.StandingsLists.map(function(r){var a=r.DriverStandings[0],e=a.Driver;return e.season=r.season,e.round=r.round,e.points=a.points,e.wins=a.wins,e.carInfo=a.Constructors[0],e})}catch(r){}finally{s.resolve(a)}},function(r){s.reject(r)}),s.promise},getSeasonWinners:function(t){var i=a.defer();if(!t)throw new Error(n.YEAR_IS_REQUIRED);var s=e.roundWinners.format(t);return r.jsonp(s,{jsonpCallbackParam:"callback"}).then(function(r){var a=[];try{a=r.data.MRData.RaceTable.Races.map(function(r){var a=r.Results[0],e=a.Driver,n=a.Time,t={};return t.date=r.date,t.raceName=r.raceName,t.laps=a.laps,t.driverId=e.driverId,t.familyName=e.familyName,t.givenName=e.givenName,t.nationality=e.nationality,t.url=e.url,t.season=r.season,t.carInfo=a.Constructor,t.time=n?n.time:"-",t.status=a.status,t})}catch(r){}finally{i.resolve(a)}},function(r){i.reject(r)}),i.promise}}}]);
APP.controller("aboutController",["$scope","$rootScope",function(o,t){o.activeMenu="about",o.toggleNavMini=function(){t.compactNav=!t.compactNav}}]);
APP.controller("detailsController",["$scope","$stateParams","$rootScope","RaceWinnerModel","driversService",function(e,o,n,a,s){e.driver=o.driverId,e.season=o.seasonId,e.activeMenu="home",e.loaded=!0,e.seasonInfo=[],e.toggleNavMini=function(){n.compactNav=!n.compactNav},function(o){e.loaded=!1,s.getSeasonWinners(o).then(function(o){e.seasonInfo=o.map(a.create),e.loaded=!0})}(e.season)}]);
APP.controller("docsController",["$scope","$rootScope",function(o,c){o.activeMenu="docs",o.toggleNavMini=function(){c.compactNav=!c.compactNav}}]);
APP.controller("homeController",["$scope","driversService","WinnerModel","$rootScope","$timeout",function(e,r,t,a,o){function n(r){r?e.loaded=!1:o(function(){e.loaded=!0},20)}e.loaded=!1,e.activeMenu="home",e.search={text:" "},e.drivers=[],e.yearsRange={fromYear:2005,toYear:2015},e.toggleNavMini=function(){a.compactNav=!a.compactNav},e.filterValues=function(){var r=e.search.text,t=r.toLowerCase();e.drivers=a.driversData.filter(function(e){return 0===(e.year+"").indexOf(r)||e.fullName().toLowerCase().indexOf(t)>=0})},a.driversData.length?(e.filterValues(),n(!1)):function(o,i){n(!0),r.getWinnersList(o,i).then(function(r){a.driversData=r.map(t.create),e.filterValues(),n(!1)})}(e.yearsRange.fromYear,e.yearsRange.toYear),e.$watch("search.text",e.filterValues)}]);
APP.directive("formulaSearchInput",[function(){return{restrict:"EA",template:'<input type="text" class="search-input" value="{{ngModel.trim()}}" placeholder="SEARCH"/>',transclude:!0,link:function(n,e,t,u,i){function l(){var t=e.find("input");t&&n.ngModel&&(n.ngModel=t.val()||" ")}i(n,function(n,t){e.append(n)}),t.ui||(t.ui="default"),e.addClass(t.ui),e.bind("blur keyup change",function(){n.$apply(l)})},scope:{ngModel:"=",ui:"@ui"}}}]);
APP.directive("menuLink",function(){return{restrict:"EA",templateUrl:"/templates/components/menuLink.html?_="+DONT_CHACHE,link:function(e,c,i){i.ui||(i.ui="default"),c.addClass(i.ui),i.sref||i.click?e.mode=i.sref?"sref-mode":"click-mode":e.mode="none"},scope:{text:"@text",iconCls:"@iconCls",active:"=active",compact:"=compact",sref:"@sref",click:"@click",ui:"@ui"}}});
APP.directive("winLoading",function(){return{restrict:"EA",templateUrl:"/templates/components/winLoading.html?_="+DONT_CHACHE,replace:!0}});
APP.directive("winnerItem",function(){return{restrict:"EA",templateUrl:"/templates/components/winnerItem.html?_="+DONT_CHACHE,replace:!0,compile:function(e,t){t.ui||(t.ui="default"),e.addClass(t.ui)},scope:{itemData:"=itemData",ui:"@ui"}}});
APP.service("modelUtils",[function(){return{parseFlagPrefix:function(e){var r=e.toLowerCase();switch(r){case"british":return"gb";case"spanish":return"es";case"german":return"de";default:return r.substr(0,2)}}}}]);
APP.factory("RaceWinnerModel",["modelUtils",function(t){function a(a){this.date=a.date,this.raceName=a.raceName,this.laps=a.laps,this.driverId=a.driverId,this.firstName=a.familyName,this.lastName=a.givenName,this.flagPrefix=t.parseFlagPrefix(a.nationality),this.url=a.url,this.season=a.season,this.time=a.time,this.status=a.status,a.carInfo?this.manufacturer={name:a.carInfo.name,info:a.carInfo.url,logo:a.carInfo.name.toLowerCase().replace(/\s/g,"")}:this.manufacturer=null}return a.prototype.fullName=function(){return"{0} {1}".format(this.lastName,this.firstName)},{create:function(t){return new a(t)}}}]);
APP.factory("WinnerModel",["modelUtils",function(t){function e(e){this.id=e.driverId,this.firstName=e.familyName||"",this.lastName=e.givenName||"",this.year=e.season||"",this.round=e.round||"",this.points=e.points||"",this.wins=e.wins||"",this.infoUrl=e.url||"",this.dateOfBirth=e.dateOfBirth?new Date(Date.parse(e.dateOfBirth)).toDateString():"",this.flagPrefix=t.parseFlagPrefix(e.nationality),e.carInfo?this.manufacturer={name:e.carInfo.name,info:e.carInfo.url,logo:e.carInfo.name.toLowerCase().replace(/\s/g,"")}:this.manufacturer=null}return e.prototype.fullName=function(){return"{0} {1}".format(this.lastName,this.firstName)},{create:function(t){return new e(t)}}}]);