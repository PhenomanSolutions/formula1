As we are using Angular and ofcourse we need to download angular templates, it is impossible to do it by only clicking on index.html as it will cause CrossOrigin exception
